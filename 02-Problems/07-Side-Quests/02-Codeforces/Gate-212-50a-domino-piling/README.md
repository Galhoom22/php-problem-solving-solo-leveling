...
## System Brief
Codeforces 50A: max number of 2×1 dominos on an M×N board.
...
- Integer division.
### Job takeaway
- "Domino count is area/2."

## Clear Rule
Optional ✅ in `02-Problems/README.md` Side Quest section. Does **not** unlock higher required Gates by itself.

## Source
Source: Codeforces — 50A — Domino piling — https://codeforces.com/problemset/problem/50/A  
