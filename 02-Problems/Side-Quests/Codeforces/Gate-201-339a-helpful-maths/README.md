...
Problem: 339A  
Pattern tag: Strings / Sort

## System Brief
Codeforces 339A: sum string like `3+2+1` → reorder summands ascending → `1+2+3`.
...
### Direct
- Normalize joined lists.
### Indirect
- Parse + sort + join.
### Job takeaway
- "Helpful maths is sort then join."

## Clear Rule
Optional ✅ in `02-Problems/README.md` Side Quest section. Does **not** unlock higher required Gates by itself.

## Source
Source: Codeforces — 339A — Helpful Maths — https://codeforces.com/problemset/problem/339/A  
